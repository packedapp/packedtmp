...
// I don't like it
public sealed interface BindingKind2 {
     ...
     **/
    public record Annotations(Set<Annotation> annotations) implements BindingKind2 {}
     ...
     */
    public record Manual() implements BindingKind2 {}
     ...
     */
    // I don't really a class called Service here
    public record Service() implements BindingKind2 {}
}
