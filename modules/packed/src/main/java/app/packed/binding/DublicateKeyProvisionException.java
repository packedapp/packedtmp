...
/** An exception that is typically thrown when attempting to provide multiple services under the same key. */
//was KeyAlreadyProvidedException
public class DublicateKeyProvisionException extends BuildException {
     ...
     *            method.
     */
    public DublicateKeyProvisionException(String message) {
        super(message);
    }
     ...
     *            method.
     */
    public DublicateKeyProvisionException(String message, Throwable cause) {
        super(message, cause);
    }
}
