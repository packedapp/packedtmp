...
public class KeyAlreadyProvidedException extends BuildException {
     ...
     *            method.
     */
    public KeyAlreadyProvidedException(String message) {
        super(message);
    }
     ...
     *            method.
     */
    public KeyAlreadyProvidedException(String message, Throwable cause) {
        super(message, cause);
    }
}
