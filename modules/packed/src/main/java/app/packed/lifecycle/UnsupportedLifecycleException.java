...
// Was ManagedBeanRequiredException
...
public class UnsupportedLifecycleException extends BuildException {
     ...
     *            method.
     */
    public UnsupportedLifecycleException(String message) {
        super(message);
    }
     ...
     *            method.
     */
    public UnsupportedLifecycleException(String message, Throwable cause) {
        super(message, cause);
    }
}