 ...
 */
@ValueBased
public final class RegionalLifetimeMirror extends LifetimeMirror {
     ...
     */
    private final RegionalLifetimeSetup lifetime;

    /** Creates a new lifetime mirror. */
    RegionalLifetimeMirror(RegionalLifetimeSetup lifetime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RegionalLifetimeMirror other = (RegionalLifetimeMirror) obj;
     ...
     */
    @Override
    RegionalLifetimeSetup lifetime() {
        return lifetime;
    }

    /** {@return any parent lifetime this lifetime is contained within.} */
    @Override
    public Optional<RegionalLifetimeMirror> parent() {
