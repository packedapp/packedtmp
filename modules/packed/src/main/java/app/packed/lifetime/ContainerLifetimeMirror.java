 ...
 */
public final class ContainerLifetimeMirror extends LifetimeMirror implements TreeNodeMirror<ContainerLifetimeMirror> {
    ...
    // Should probably be a container tree
