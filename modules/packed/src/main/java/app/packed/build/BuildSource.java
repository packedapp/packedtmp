...
/**
 * All applications are build on the basis of various types of build sources. Where the "root" build source is always a
 * single {@link Assembly}.
 * <p>
 * Typically, assemblies are created by the application developer. Extensions are primary resuable, but in some situations application developers will need to create their own.
 * And build transformers are a mix of the two.
 */
...
// Maybe only have BuildSourceMirror idk.
public sealed interface BuildSource permits Assembly, Extension, BuildTransformer {}
