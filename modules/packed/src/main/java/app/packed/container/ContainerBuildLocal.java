 ...
 */
public sealed interface ContainerBuildLocal<T> extends BuildLocal<ContainerBuildLocal.Accessor, T> permits PackedContainerBuildLocal {
     ...
     */
    static <T> ContainerBuildLocal<T> of() {
        return new PackedContainerBuildLocal<>(null);
    }

    static <T> ContainerBuildLocal<T> of(Supplier<? extends T> initialValueSupplier) {
        return new PackedContainerBuildLocal<>(initialValueSupplier);
    }
