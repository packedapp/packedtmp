 ...
 */
package app.packed.container.scopedresource.old;
...
interface EventBusScopedMirror extends ContainerScopedMirror<String> {}

// Scope X Key
interface ConfigScopedMirror extends ContainerScopedMirror<String> {}
