 ...
 */
// Rename to BundleHook if we end up including composers, Which I think we will
...
public @interface AssemblySetup {
    ...
    //// Hvad med bundles som extension's define????
    //// Bundles med realm=Appplication eller realm=SomeExtension
    /** {@return the processors that should be applied for every bundle the assembly defines.} */
...
//// paa link(BundleAssembly) or link
// boolean includeInnerBundles();
