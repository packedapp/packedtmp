...
import internal.app.packed.container.BuildtimeWireletSelection;
...
public sealed interface OldWireletSelection<W extends Wirelet> permits BuildtimeWireletSelection {
     ...
     */
    public static <W extends Wirelet> OldWireletSelection<W> of() {
        @SuppressWarnings("unchecked")
        OldWireletSelection<W> ws = (OldWireletSelection<W>) BuildtimeWireletSelection.EMPTY;
        return ws;
    }
     ...
     */
    @SafeVarargs
    public static <W extends Wirelet> OldWireletSelection<W> of(Class<? extends W> wireletClass, Wirelet... wirelets) {
        return BuildtimeWireletSelection.of(wireletClass, wirelets);
    }
}
