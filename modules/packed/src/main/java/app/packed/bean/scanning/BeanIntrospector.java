...
public non-sealed abstract class BeanIntrospector implements Accessor {
    ...
    public final boolean isInContainerLifetime() {
        return bean().lifetime instanceof RegionalLifetimeSetup;
    }

    public void onAnnotatedClass(BeanClass clazz, Annotation annotation) {
     ...
     */
    public void onAnnotatedClass(BeanClass clazz, AnnotationList annotations) {
        for (Annotation a : annotations) {
            onAnnotatedClass(clazz, a);
        }
    }
     ...
     */
    public void onAnnotatedMethod(BeanMethod method, AnnotationList annotations) {
        for (Annotation a : annotations) {
     ...
     */
    public void onAnnotatedVariable(BindableVariable binder, Annotation hook) {
     ...
     * @see #afterHooks()
     */
    // Syntes maaske ikke vi skal have start op stop, naar vi har det med lifecycle.
    // Bare for 100 at goere det klart at det er noget andet
    public void onBegin() {}
