...
public class UnavailableLifecycleException extends BuildException {
     ...
     *            method.
     */
    public UnavailableLifecycleException(String message) {
        super(message);
    }
     ...
     *            method.
     */
    public UnavailableLifecycleException(String message, Throwable cause) {
        super(message, cause);
    }
}