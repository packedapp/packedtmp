...
public class InstanceMembersNotAllowedException extends BeanInstallationException {
     ...
     *            method.
     */
    public InstanceMembersNotAllowedException(String message) {
        super(message);
    }
     ...
     *            method.
     */
    public InstanceMembersNotAllowedException(String message, Throwable cause) {
        super(message, cause);
    }
}
