...
public @interface OtherBeanHook {
    ...
    Class<? extends OldBClass>[] classAnnotated() default {};

    Class<? extends OldBClass>[] classAnnotatedAllAccess() default {};
//
...
//    Class<? extends BeanField>[] fieldAnnotatedSettable() default {};
    ...
    Class<? extends ScrapBeanMethod>[] methodAnnotated() default {};

    Class<? extends ScrapBeanMethod>[] methodAnnotatedAccessible() default {};
...
@interface Zarchive {
    ...
    Class<? extends OldBClass>[] classSubclass() default {}; // Interfaces not supported

    Class<? extends OldBClass>[] classSubclassAllAccess() default {}; // Interfaces not supported
