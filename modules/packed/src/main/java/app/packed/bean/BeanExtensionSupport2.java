...
public class BeanExtensionSupport2 extends ExtensionSupport {
    ...
    BeanExtensionSupport2(BeanExtension2 extension, Operator agent) {
    ...
    public final <T, B extends BeanConfiguration<T>> B registerChild(Operator agent, ComponentConfiguration parent, BeanDriver driver, B configuration,
