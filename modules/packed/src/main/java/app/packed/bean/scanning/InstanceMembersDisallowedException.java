...
// CannotDeclareInstanceMembersException
public class InstanceMembersDisallowedException extends BeanInstallationException {
     ...
     *            method.
     */
    public InstanceMembersDisallowedException(String message) {
        super(message);
    }
     ...
     *            method.
     */
    public InstanceMembersDisallowedException(String message, Throwable cause) {
        super(message, cause);
    }
}
