...
import app.packed.bean.hooks.sandboxinvoke.MetaAnnotationReader;
import app.packed.bean.hooks.sandboxinvoke.VarInjector;
import app.packed.bean.oldhooks.sandbox.MethodAccessor;
...
public abstract class OldBeanField {
    ...
    protected final <T extends OldBeanClass> T manageBy(Class<T> type) {
