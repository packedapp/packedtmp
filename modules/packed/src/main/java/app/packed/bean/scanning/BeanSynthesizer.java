...
// Was BeanClassMutator
//

public interface BeanSynthesizer {

//    // Just to test vs BeanPrepper
//    default BeanSynthesizer ignoreMethodsStartingWith(String name) {
//        return this;
//    }
//
  ...
  //  void skipScan(@SuppressWarnings("unchecked") Class<? extends OnBase>... elements);
    ...
    static void forceTransform(Lookup lookup, Class<?> beanClass, Consumer<? super BeanSynthesizer> transformation) {
        throw new UnsupportedOperationException();
    }

    // What about subclassing?
    static void forceTransform(Lookup lookup, Consumer<? super BeanSynthesizer> transformation) {
        forceTransform(lookup, lookup.lookupClass(), transformation);
    }

    // hmm IDK about this
    static void forceTransformSubclassesOf(Lookup lookup, Consumer<? super BeanSynthesizer> transformation) {
        forceTransform(lookup, lookup.lookupClass(), transformation);
    }
