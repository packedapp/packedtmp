...
import static app.packed.bean.operation.mh.MethodHandleUtil.afterInterceptor;
import static app.packed.bean.operation.mh.MethodHandleUtil.aroundInterceptor;
import static app.packed.bean.operation.mh.MethodHandleUtil.beforeInterceptor;
import static app.packed.bean.operation.mh.MethodHandleUtil.invokeAndReturnArg;
