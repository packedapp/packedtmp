 ...
 *
 */
public interface UnmanagedApplicationRegistry<I, H extends ApplicationHandle<I, ?>> {
     ...
     */
    Optional<Launcher<I>> application(String name);

    /** {@return a stream of all installed applications in this repository} */
    Stream<Launcher<I>> applications();
