...
public interface AppNew extends AutoCloseable {
    ...
    private static BootstrapApp<AppNew> bootstrap() {
    ...
    static AppNew start(Assembly assembly, Wirelet... wirelets) {
    ...
    public static final class Image {
        ...
        private final BootstrapApp.Image<AppNew> image;

        private Image(BootstrapApp.Image<AppNew> image) {
            this.image = image;
        }
         ...
         *            optional wirelets
         */
        public AppNew start(Wirelet... wirelets) {
