...
public final class App {
    ...
    public static void mainImage(Bundle<?> assembly, Wirelet... wirelets) {
        // Som cli. Men optimeret for lavt hukommelse
        // Vi clear'er altid vores bean cache faetre naar vi laver images
        throw new UnsupportedOperationException();
    }

    public static void cli(Bundle<?> assembly, Wirelet... wirelets) {
    ...
    public static ServiceLocator serviceLocator(Bundle<?> assembly, Wirelet... wirelets) {
    ...
    public static ApplicationImage<ServiceLocator> serviceLocatorImage(Bundle<?> assembly, Wirelet... wirelets) {
        return ServiceLocator.imageOf(assembly, wirelets);
    }

    public static ApplicationMirror serviceLocatorMirror(Bundle<?> assembly, Wirelet... wirelets) {
