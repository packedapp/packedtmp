...
public class ApplicationException extends Exception {
    ...
    public ApplicationException(RunState state, OperationSite operationSite, String message, Throwable cause) {
        super(message, cause);
        this.state = requireNonNull(state);
        this.operationSite = requireNonNull(operationSite);
    }

    public ApplicationException(RunState state, OperationSite operationSite, Throwable cause) {
        super(cause);
        this.state = requireNonNull(state);
        this.operationSite = requireNonNull(operationSite);
    }
