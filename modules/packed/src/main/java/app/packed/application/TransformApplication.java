...
import app.packed.application.TransformApplication.ApplicationIs;
...
@Documented
@Inherited
@Repeatable(TransformApplication.All.class)
public @interface TransformApplication {
    ...
    @interface All {
        ...
        TransformApplication[] value();
    }

    @interface ApplicationIs {

        // Problemet med tagged er at, vi kan tilføje det dynamisk
        // Saa det fungere ikke ordentligt
...
@TransformApplication(ifApplication = @ApplicationIs(applicationAssemblyIs = @AssemblyMatcher(annotatedWithAny = Deprecated.class)), value = ApplicationTransformer.class)
class TestIt {
