...
import app.packed.application.ComponentPath.Schema.FragmentKind;
 ...
 *
 */
final /* primitive */ class PackedComponentPath implements ComponentPath {
    final Object[] fragments; // We need to have a canonical representation of
    ...
    static final class ComponentPathSchemaBuilder implements ComponentPath.Schema.Builder {
