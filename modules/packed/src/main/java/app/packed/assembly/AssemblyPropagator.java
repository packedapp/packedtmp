...
public interface AssemblyPropagator {
    ...
    public final class All implements AssemblyPropagator {
    ...
    public final class IfOpen implements AssemblyPropagator {
    ...
    public final class Local implements AssemblyPropagator {
