...
import packed.internal.bean.oldhooks.usesite.UseSiteFieldHookModel.Builder;
...
public class FieldHelper extends DependencyHolder {
    ...
    public FieldHelper(BeanField field, Builder builder, VarHandle mh) {
        super(List.of(), false, null);
