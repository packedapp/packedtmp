 ...
 */
package sandbox.app.packed.application.registry.v2;
...
public interface ApplicationRepository2<I extends ApplicationImage> extends Iterable<I> {
     ...
     */
    // Maaske er der snarre ApplicationConfiguration man skal have???
    I install(Function<? super ApplicationInstaller<?>, ?> installer);
