...
import app.packed.service.bridge.old.ServiceToChildTransformer;
...
//    }
    ...
    public static Wirelet transformRequirements(Consumer<? super ServiceToChildTransformer> transformation) {
        requireNonNull(transformation, "transformation is null");
        throw new UnsupportedOperationException();
