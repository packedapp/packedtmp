...
//            throw e;
    ...
    private MethodHandle provide(OperationSetup operation, MethodHandle mh, BindingAccessor p) {
        if (p instanceof FromConstant c) {
            ...
            MethodHandle methodHandle = fo.operation().codeHolder.newMethodHandle();
            ...
            MethodHandle tmp = MethodHandles.insertArguments(PackedExtensionContext.MH_CONSTANT_POOL_READER, 1, fla.index().index);
