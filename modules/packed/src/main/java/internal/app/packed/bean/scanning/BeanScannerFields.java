 ...
 *
 */
class BeanScannerFields {

     static void introspect(BeanScanner scanner, Class<?> clazz) {
        ...
        if (clazz.getModule() != BeanScanner.JAVA_BASE_MODULE) {
            ...
            introspect(scanner, clazz.getSuperclass());
            ...
            for (Field field : clazz.getDeclaredFields()) {
                BeanScannerFields.fieldIntrospect(scanner, field);
            }
    ...
    static void fieldIntrospect(BeanScanner scanner, Field field) {
        ...
        case 1 -> {
            ...
            if (hook != null) {
                ...
                new IntrospectorOnField(scanner, field, pal, pal, hook).onHook();
                return;
            }
        }
        case 2 -> {
            ...
            if (hook0 != null) {
                ...
                if (hook1 == null) {
                    new IntrospectorOnField(scanner, field, pal, new PackedAnnotationList(a0), hook0).onHook();
                } else if (hook0.extensionType() == hook1.extensionType()) {
                    new IntrospectorOnField(scanner, field, pal, new PackedAnnotationList(a0, a1), hook0, hook1).onHook();
                } else {
                    // TODO sort
                    new IntrospectorOnField(scanner, field, pal, new PackedAnnotationList(a0), hook0).onHook();
                    new IntrospectorOnField(scanner, field, pal, new PackedAnnotationList(a1), hook1).onHook();
                }
                return;
            } else if (hook1 != null) {
        ...
        default -> {
            ...
            for (List<Pair> list : map.values()) {
                ...
                new IntrospectorOnField(scanner, field, pal, new PackedAnnotationList(hooks), ha).onHook();
            }
            return;
        }
        }
