...
public class MethodHandleUtil {
    ...
    public record LazyResolvable(MethodHandle handle, Runnable resolveNow) {}

    public static LazyResolvable lazyF(MethodType mt, Supplier<MethodHandle> supplier) {
        ...
        return new LazyResolvable(callSite.dynamicInvoker(), () -> lazy.resolveNow());
    }
