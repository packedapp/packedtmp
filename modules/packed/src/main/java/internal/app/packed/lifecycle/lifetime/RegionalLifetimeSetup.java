 ...
 * container.
 */
public final class RegionalLifetimeSetup extends AbstractTreeNode<RegionalLifetimeSetup> implements LifetimeSetup {
    ...
    public final RegionalEntryPointManager entryPoints = new RegionalEntryPointManager();
    ...
    public final List<LifecycleOperationStartHandle> startersPost = new ArrayList<>();

    public final List<LifecycleOperationStartHandle> startersPre = new ArrayList<>();
     ...
     * @param parent
     */
    public RegionalLifetimeSetup(PackedContainerInstaller<?> installer, ContainerSetup newContainer, @Nullable RegionalLifetimeSetup parent) {
        super(parent);
    ...
    @Override
    public RegionalLifetimeMirror mirror() {
    ...
    private void orderDependenciesBeans0(BeanSetup bean) {
        for (List<BeanLifecycleOperationHandle> lop : bean.operations.lifecycleHandles.values()) {
            for (BeanLifecycleOperationHandle h : lop) {
                ...
                case INITIALIZE_POST_ORDER -> startersPost.addFirst((LifecycleOperationStartHandle) h);
                case START_PRE_ORDER -> startersPre.add((LifecycleOperationStartHandle) h);
                case START_POST_ORDER -> startersPost.addFirst((LifecycleOperationStartHandle) h);
    ...
    /** {@inheritDoc} */
    @Override
    public @Nullable RegionalLifetimeSetup parent() {
        return treeParent;
    }
