...
public sealed interface OldWireletSelection<W extends Wirelet> permits BuildtimeWireletXelection {
     ...
     */
    static <W extends Wirelet> OldWireletSelection<W> of() {
        @SuppressWarnings("unchecked")
        OldWireletSelection<W> ws = (OldWireletSelection<W>) BuildtimeWireletXelection.EMPTY;
        return ws;
    }
     ...
     */
    @SafeVarargs
    static <W extends Wirelet> OldWireletSelection<W> of(Class<? extends W> wireletClass, Wirelet... wirelets) {
        return BuildtimeWireletXelection.of(wireletClass, wirelets);
    }
}
