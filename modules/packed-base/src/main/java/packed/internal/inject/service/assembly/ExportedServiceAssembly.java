...
public final class ExportedServiceAssembly<T> extends ServiceAssembly<T> {
     ...
     */
    public ExportedServiceAssembly(ContainerInjectionManager builder, Key<T> key, ConfigSite configSite) {
     ...
     */
    public ExportedServiceAssembly(ContainerInjectionManager builder, ServiceAssembly<T> entryToExport, ConfigSite configSite) {
