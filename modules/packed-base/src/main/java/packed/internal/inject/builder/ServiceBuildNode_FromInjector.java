...
public class ServiceBuildNode_FromInjector<T> extends ServiceBuildNode<T> {
    ...
    ServiceBuildNode_FromInjector(ContainerBuilder injectorConfiguration, InternalConfigurationSite configurationSite, ProvideAll binding,
            ServiceNode<T> node) {
