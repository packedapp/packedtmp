...
public final class XRuntimeNodeProvidesMethod<T> {
    //
    ...
    // public RuntimeNodeProvidesMethod(XBuildNodeProvidesMethod<T> node) {
    // super(node);
    ...
    // InjectionSite is = null;// InternalInjectionSite.of(node.getInjector(), key, node.getContainer(),
    // node.getDeclaringComponent());
