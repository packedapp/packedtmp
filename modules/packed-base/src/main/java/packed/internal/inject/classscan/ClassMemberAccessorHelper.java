...
final class ClassMemberAccessorHelper {
     ...
     *            the method
     */
    private ClassMemberAccessorHelper(Method method) {
    ...
    public boolean equals(Object obj) {
        ClassMemberAccessorHelper e = (ClassMemberAccessorHelper) obj;
    ...
    static <T extends Throwable> void find(Class<?> baseType, Class<?> actualType, ThrowableConsumer<? super Method, T> methodConsumer,
        ...
        HashMap<ClassMemberAccessorHelper, HashSet<Package>> types = new HashMap<>();
                ...
                for (Method m : c.getDeclaredMethods()) {
                    ...
                    if (Modifier.isStatic(mod)) {
                        ...
                        default: // default access
                            HashSet<Package> pkg = types.computeIfAbsent(new ClassMemberAccessorHelper(m), key -> new HashSet<>());
                        ...
                        case Modifier.PROTECTED:
                            if (types.putIfAbsent(new ClassMemberAccessorHelper(m), packages) != null) {
