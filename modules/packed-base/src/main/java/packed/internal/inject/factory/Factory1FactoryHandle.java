...
final class Factory1FactoryHandle<T> extends FactoryHandle<T> {
    ...
    private Factory1FactoryHandle(TypeLiteral<T> type, Function<?, ? extends T> function, List<DependencyDescriptor> dependencies) {
        super(type);
