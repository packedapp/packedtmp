...
public abstract class PackedUpstreamServiceWirelet extends ExtensionWirelet<InjectionExtension> {

    PackedUpstreamServiceWirelet() {
        super(InjectionExtension.class);
    }
    ...
    public static class FilterOnKey extends PackedUpstreamServiceWirelet {
        ...
        /** {@inheritDoc} */
        @Override
        protected void process(InjectionExtension extension) {
