...
public class InjectorBuilder extends AbstractContainerConfiguration {
        ...
        for (WiringOption wo : options) {
            BundleSupport.invoke().process(wo, new BundleLink() {
                ...
                public ConfigSite configSite() {
                    return InjectorBuilder.this.configurationSite();
                }
    ...
    public InjectorBuilder(InternalConfigurationSite configurationSite, @Nullable Bundle bundle, WiringOption... options) {
