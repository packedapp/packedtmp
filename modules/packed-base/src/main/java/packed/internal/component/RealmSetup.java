...
public final class RealmSetup {
     ...
     */
    private RealmSetup(RealmSetup existing, PackedBundleDriver<?> driver, ComponentSetup linkTo, Bundle<?> assembly, Wirelet[] wirelets) {
        this.realmType = assembly.getClass();
    ...
    public RealmSetup link(PackedBundleDriver<?> driver, ComponentSetup linkTo, Bundle<?> assembly, Wirelet[] wirelets) {
