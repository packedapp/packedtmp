...
public final class OldPackedClassComponentDriver<C extends ComponentConfiguration> extends PackedComponentDriver<C> {

    @SuppressWarnings("rawtypes")
    public static final ComponentDriver INSTALL_DRIVER = OldPackedClassComponentDriver.ofInstance(MethodHandles.lookup(), ServiceComponentConfiguration.class, true);

    /** A driver for this configuration. */
    @SuppressWarnings("rawtypes")
    public static final ComponentDriver STATELESS_DRIVER = OldPackedClassComponentDriver.ofClass(MethodHandles.lookup(), BaseComponentConfiguration.class);
    ...
    OldPackedClassComponentDriver(Inner meta, Object data) {
    ...
    public ComponentDriver<C> bind(Object object) {
        ...
        return new OldPackedClassComponentDriver<>(inner, object);
    }
    ...
    public static <C extends ComponentConfiguration> ComponentDriver<C> ofClass(MethodHandles.Lookup caller, Class<? extends C> driverType) {
        return new OldPackedClassComponentDriver<>(newMeta(Type.CLASS, caller, driverType, false), null);
    }
    ...
    public static <C extends ComponentConfiguration> ComponentDriver<C> ofFactory(MethodHandles.Lookup caller, Class<? extends C> driverType,
        ...
        return new OldPackedClassComponentDriver<>(meta, null);
    }
    ...
    record Inner(Type type, MethodHandle mh, int modifiers, PackedComponentModifierSet modifiersSet) {
        ...
        void checkBound(OldPackedClassComponentDriver<?> driver) {
