...
public final class SidecarContextDependencyProvider implements DependencyProvider {
    ...
    private SidecarContextDependencyProvider(AbstractHookBootstrapModel<?> sidecarModel, Builder builder) {
    ...
    static class Builder {
        ...
        SidecarContextDependencyProvider build(AbstractHookBootstrapModel<?> sidecarModel) {
