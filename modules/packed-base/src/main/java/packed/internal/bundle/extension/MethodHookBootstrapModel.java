...
import app.packed.container.MethodHook.Bootstrap;
...
public final class MethodHookBootstrapModel extends AbstractHookBootstrapModel<RealMethodSidecarBootstrap> {
    ...
    /** A builder for method sidecar. This class is public because it used from {@link RealMethodSidecarBootstrap}. */
