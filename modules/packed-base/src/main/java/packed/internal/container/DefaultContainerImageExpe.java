...
public class DefaultContainerImageExpe implements ContainerImage {

    DefaultContainerImageExpe.Builder builder(ContainerSource source, Wirelet... wirelets) {
        return new Builder();
    }
    ...
    @Override
    public DefaultContainerImageExpe with(Wirelet... wirelets) {
        throw new UnsupportedOperationException();
    }

    @Override
    public DefaultContainerImageExpe withName(String name) {
     ...
     * @param wirelets
     */
    static DefaultContainerImageExpe of(ContainerSource source, Wirelet... wirelets) {
        throw new UnsupportedOperationException();
    }
    ...
    static class Usage {
        private final DefaultContainerImageExpe someBundle = DefaultContainerImageExpe.of(new MainTest());
