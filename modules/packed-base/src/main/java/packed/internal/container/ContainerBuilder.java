...
public final class ContainerBuilder extends InjectorBuilder {
     ...
     */
    public ContainerBuilder(InternalConfigurationSite configurationSite, WiringOption... options) {
        super(configurationSite, options);
    }

    public ContainerBuilder(InternalConfigurationSite configurationSite, Bundle bundle, WiringOption... options) {
    ...
    public Container build() {
        ...
        for (WiringOption wo : options) {
            BundleSupport.invoke().process(wo, new BundleLink() {
    ...
    public void wireContainer(Bundle bundle, WiringOption... stages) {
        throw new UnsupportedOperationException();
    }
