...
public final class PackedInstantiationContext {
    ...
    /** All context objects. */
    private final IdentityHashMap<BundleConfiguration, IdentityHashMap<Class<?>, Object>> map = new IdentityHashMap<>();
    ...
    @Nullable
    public <T> T get(BundleConfiguration configuration, Class<T> type) {
    ...
    public void put(BundleConfiguration configuration, Object obj) {
        requireNonNull(configuration, "configuration is null");
