...
public final class TimeWirelet extends Wirelet {
    private TimeWirelet() {}
     ...
     */
    public static TimeWirelet zone(String zoneId) {
     ...
     * @see #zoneId(ZoneId)
     */
    public static TimeWirelet zone(ZoneId zoneId) {
        throw new UnsupportedOperationException();
    }

    public static TimeWirelet clock(Clock clock) {
        throw new UnsupportedOperationException();
    }
}
