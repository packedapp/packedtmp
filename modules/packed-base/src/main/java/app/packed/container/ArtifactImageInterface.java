 ...
 */
// Det giver jo altsaa ikke rigtig nogen mening at have denne som et interface...
// What are people going to do with it...
public interface ArtifactImageInterface extends Artifact, ArtifactSource {
    ...
    default ArtifactImageInterface with(Wirelet... wirelets) {
     ...
     */
    default ArtifactImageInterface withName(String name) {
     ...
     */
    static ArtifactImageInterface of(ArtifactSource source, Wirelet... wirelets) {
