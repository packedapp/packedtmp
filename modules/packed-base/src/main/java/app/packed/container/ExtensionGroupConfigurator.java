...
public abstract class ExtensionGroupConfigurator<E extends Extension<E>, B extends ExtensionGroupConfigurator.Builder<E>> {
     ...
     */
    protected abstract B newBuilder(Class<?> componentType);

    protected final <A extends Annotation> void onAnnotatedMethod(Class<A> annotationType, BiConsumer<AnnotatedMethodHook<A>, B> consumer) {
        throw new UnsupportedOperationException();
    }

    // Eller kan extensionen selv klare det???
