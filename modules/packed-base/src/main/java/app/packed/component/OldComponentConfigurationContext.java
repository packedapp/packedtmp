...
/**
 * A context object used by {@link ComponentConfiguration}.
 *
 * @apiNote In the future, if the Java language permits, {@link OldComponentConfigurationContext} may become a
 *          {@code sealed} interface, which would prohibit subclassing except by explicitly permitted types.
 */
public interface OldComponentConfigurationContext {
    ...
    default void onNamed(Consumer<? super ComponentConfigurationContext> action) {
