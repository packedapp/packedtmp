...
public interface AccessibleMethod {
    ...
    // Must be open to Packed +
    // OpensFor annotation for Method m

    // Maaske er den bare direkte paa AccessibleClass
    static MethodHandle newInvoker(MethodHandles.Lookup caller, Method m) {
        throw new UnsupportedOperationException();
    }

    public static void main(String[] args) {
        of(MethodHandles.lookup(), null).newMethodHandle();
    }

    static AccessibleMethod of(MethodHandles.Lookup caller, Method m) {
        throw new UnsupportedOperationException();
    }
}
