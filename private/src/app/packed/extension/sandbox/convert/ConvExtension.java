...
public class ConvExtension extends Extension<ConvExtension> implements ConvDiscovable {
    ...
    protected <E extends Extension<E>, X> ExtensionBeanDoubly<E, X> findFirst(Class<E> extensionType, Class<X> extensorType) {
    ...
    protected void onUserClose() {
        ...
        use(BeanSupport.class).install(ConvExtensor.class); // instantiate a new ConvExtensor (may already have been auto installed)
    }
